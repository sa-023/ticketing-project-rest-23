...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> getProjects(){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Projects are successfully retrieved",projectDTOList, HttpStatus.OK));// OK -> 200
    }
    ...
    public ResponseEntity<ResponseWrapper> createProject(@RequestBody ProjectDTO project){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("Project is successfully created",HttpStatus.CREATED));// CREATED -> 201
    }
